...
export default function ToDoList(){
    return (
        <div className="w-60 h-80 flex flex-col items-center bg-linear-to-br from-[#294d4d]/90 via-[#2e6161] to-[#294d4d]/90 overflow-hidden border-4 border-gray-900 rounded-xl">
            ...
            <div className="flex gap-3 mt-3 items-center justify-center">
                <input type="text" id="username" className="bg-white font-jersey text-l indent-1 border-b-[#94c9cc] border-b-6 " size={13} placeholder="Enter Task..."/>
